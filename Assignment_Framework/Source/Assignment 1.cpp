...
int main(int argc, char* argv[]) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        renderShapeFromCSV("../Assets/Shapes/Jack's Wall.csv", glm::vec3(0.0f, 0.0f, 0.0f), scale, drawMode, 0.0f, shaderProgram);
        renderShapeFromCSV("../Assets/Shapes/MelWall.csv", glm::vec3(-10.0f, 0.0f, -5.0f), scale, drawMode, 0.0f, shaderProgram);
        renderShapeFromCSV("../Assets/Shapes/Cedrik's Wall.csv", glm::vec3(0.0f, 0.0f, 0.0f), scale, drawMode, 0.0f, shaderProgram);
        renderShapeFromCSV("../Assets/Shapes/Alex's Wall.csv", glm::vec3(10.0f, 0.5f, 10.0f), scale, drawMode, 0.0f, shaderProgram);
